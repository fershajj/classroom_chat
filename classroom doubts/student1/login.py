...
def register_user():
    ...
    isFile = os.path.isfile("root\\classroom doubts\\"+usermail_info) #root is where classroom doubts folder is saved
    if isFile:
        mail_already_exists()
    else:
        ...
        file.close()
        file = open("root\\classroom doubts\\"+usermail_info, "w")  #root is where classroom doubts folder is saved
        file.write(usermail_info + "\n")
        file.write(password_info + "\n")
        file.write(username_info )
        file.close()
...
def pwres_user():
    ...
    isFile = os.path.isfile("root\\classroom doubts\\"+tomail)  #root is where classroom doubts folder is saved
    if isFile:
